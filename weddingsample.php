        ...
        <div class="container">
            <div class="media-container-row">
                <div class="title col-12 col-md-8">
                    <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-2"><span style="font-weight: normal;">OUR WEDDING CRAD THEME</span></h2>
    ...
    <div class="container align-center">
        ...
        <div class="team-item col-lg-4 col-md-8">
                <div class="item-image">
                    <a href="wedding1/index.php"><img src="assets/images/merrige-sadibyah.jpg" alt="" title="" media-simple="true"></a>
                </div>
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p >

 <a href="wedding1/index.php">&emsp; Wedding Theme 1</a>
 <br>
 ...
 <input type="button"  value=' CREATE AND PREVIEW ' onclick="get_val();"/>
               ...
               <div class="team-item col-lg-4 col-md-8">
                ...
                <div class="item-caption py-3">
                    ...
                    <a href="theme/w4/index.html">&emsp; Wedding Theme 4</a>
                    </div><br/>
