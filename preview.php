        ...
        <div class="container">
            <div class="media-container-row">
                <div class="title col-12 col-md-8">
                    <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-2"><span style="font-weight: normal;"> WEDDING CRAD THEME PREVIEW </span></h2>
                    <h3 class="mbr-section-subtitle align-center mbr-light mbr-white pb-3 mbr-fonts-style display-5">
                        Wedding-Card PREVIEW </h3>
    ...
    <div class="container align-center">
        ...
        <div class="team-item col-lg-4 col-md-8">
                <div class="item-image">
                    <a href="wedding1/view.php"><img src="assets/images/merrige-sadibyah.jpg" alt="" title="" media-simple="true"></a>
                </div>
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p >

 <a href="wedding1/view.php">&emsp; Wedding Theme PREVIEW 1</a>
 <br>
...
<br/>
                   ...
                   <div class="team-item col-lg-4 col-md-8">
                   <div class="item-image">
                    <a href="theme/w1/w1view.php"><img src="assets/images/marriage3.jpg" alt="" title="" media-simple="true"></a>
                    </div>
                   <div class="item-caption py-3">
                    <div class="item-name px-2">
                    <p >
                    
                     <a href="theme/w1/w1view.php">&emsp; Wedding Theme PREVIEW 2</a>
                     <br>
                    </div>
                   ...
                   <div class="team-item col-lg-4 col-md-8">
                    <div class="item-image">
                    <a href="theme/w3/w3view.php"><img src="assets/images/married.jpg" alt="" title="" media-simple="true"></a>
                    </div>
                    <div class="item-caption py-3">
 

                    <a href="theme/w3/w3view.php">&emsp; Wedding Theme PREVIEW 3</a> 
                    <br/>
                    <br>
               ...
               <div class="team-item col-lg-4 col-md-8">
                <div class="item-image">
                <a href="theme/w4/w4view.php"><img src="assets/images/Love-Marriage-1.jpg" alt="" title="" media-simple="true"></a>
                </div>
                <div class="item-caption py-3">
               <div class="item-name px-2">
               <p class="mbr-fonts-style display-5"></p>

                    <a href="theme/w4/w4view.php">&emsp; Wedding PREVIEW Theme 4</a>
                    </div><br/>
