    ...
    <div class="container align-center">
        ...
        <div class="team-item col-lg-4 col-md-8">
                <div class="item-image">
                    <a href="invition/index.html"><img src="assets/images/bs.jpg" alt="" title="" media-simple="true"></a>
                </div>
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p >

 <a href="invition/index.html">&emsp; Bday Theme 1</a>
 <br>
                        
 <!-- <li>   <a href="wedding2/cardform.php  ">Create your Theam </a> </li> -->

<br/>
 <input type="button"  value=' CREATE AND PREVIEW ' onclick="bday_val();"/>
 </div>
                   ...
                   <div class="item-caption py-3">
                    ...
                    <p >
                     ...
                     <a href="invition/index.html">&emsp; Bday Theme 2</a>
                     <br>
                    </div>
                    <br>
               <!--   <input type="button"  value=' CREATE AND PREVIEW ' onclick="get_val();"/>-->
                   ...
                   <div class="team-item col-lg-4 col-md-8">
                    ...
                    <a href="theme/w3/index.html">&emsp; Bday Theme 3</a> 
                    <br/>
                    <br>
               ...
               <div class="team-item col-lg-4 col-md-8">
                ...
                <div class="item-caption py-3">
                    ...
                    <a href="theme/w4/index.html">&emsp; Bday Theme 4</a>
                    </div><br/>
